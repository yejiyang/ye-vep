...
c.....amend by wanghui
      ...
      p(4)=0.0d0
c     mat1 SAF
      if (imate.eq.1.or.imate.eq.11.or.imate.eq.21) then
      iimate=1
      p(1)=0.d0
      p(2)=10.0d6
      p(3)=prmt(2)
      p(4)=0.0d0
c     mat2 SJF
      else if (imate.eq.2.or.imate.eq.12.or.imate.eq.22) then
      iimate=1
      p(1)=0.d0
      p(2)=30.0d6
      p(3)=prmt(2)
      p(4)=0.0d0
c       mat3 GF
      else if (imate.eq.3.or.imate.eq.13.or.imate.eq.23) then
      iimate=1
      p(1)=0.d0
      p(2)=10.0d6
      p(3)=prmt(2)
      p(4)=0.0d0
cc       mat4 ESCZ, 9 means no effects
c      else if (imate.eq.9.or.imate.eq.19.or.imate.eq.29) then
c      iimate=1
c      p(1)=0.d0
c      p(2)=10.0d6
c      p(3)=prmt(2)
c      p(4)=0.0d0
c       mat5 TF
      else if (imate.eq.5.or.imate.eq.15.or.imate.eq.25) then
      iimate=1
      p(1)=0.d0
      p(2)=10.0d6
      p(3)=prmt(2)
      p(4)=0.0d0
cc       mat7 PF
c      else if (imate.eq.7.or.imate.eq.17.or.imate.eq.27) then
c      iimate=1
c      p(1)=0.d0
c      p(2)=30.0d6
c      p(3)=prmt(2)
...
cc       mat8 Basin & Range
c      if (imate.eq.9.or.imate.eq.19.or.imate.eq.29) then
c      iimate=1
c      p(1)=0.d0
c      p(2)=10.0d6
c      p(3)=prmt(2)
